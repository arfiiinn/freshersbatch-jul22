...
namespace CustomerManagementSystemPhase2.Controllers
{
        ...
        public ActionResult Search(string Searchby, string search)
        {
            try
            {
                ...
                if (Searchby == "CustomerName")
                {
                    ...
                    List<Customer> model = db.Customers.Where(c => c.CustomerName.StartsWith(search) || search == null).ToList();
                    ModelState.Clear();
                    return View(model);
                }
                else
                {
                    ...
                    List<Customer> model = db.Customers.Where(c => c.CustomerID == Convert.ToInt32(search) || search == null).ToList();
