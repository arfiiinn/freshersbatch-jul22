...
SELECT Product.[SuppliedBy], Product.[UnitPrice] AS [Total Price] ,ShipmentDetails.[ShippingCompany] AS [Shipping Company Name] 
FROM Product
...
SELECT * FROM Customer WHERE FirstName LIKE '%ra%'
